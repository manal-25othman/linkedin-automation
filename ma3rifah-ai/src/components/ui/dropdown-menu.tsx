...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronLeft className="ms-auto size-4 rtl:rotate-180" />
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    checked={checked}
    className={cn(
      'relative flex cursor-pointer select-none items-center rounded-sm py-1.5 pe-2 ps-8 text-sm outline-none focus:bg-accent',
      className,
    )}
    {...props}
  >
