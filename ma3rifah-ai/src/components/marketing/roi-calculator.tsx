          ...
          <div className="mt-6 space-y-5">
            ...
            <div className="border-t pt-5">
              <Field
                ...
                hint="لا يُجاب عن كل سؤال: بعضه لا أصل له في مستنداتكم، وبعضه يحتاج حكمًا بشريًا. خفّضيه كما تشاء."
                ...
                <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
                  {worthIt ? (
                    ...
                    <>
                      ...
                      جرّب رفع عدد الأسئلة المتكرّرة إن كان تقديرك متحفّظًا، وإلّا
