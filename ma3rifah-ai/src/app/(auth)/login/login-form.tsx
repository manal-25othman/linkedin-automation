...
const LINK_ERRORS: Record<string, string> = {
  ...
  // انتهاء الجلسة ليس خطأً من المستخدم، فالنبرة خبرٌ لا لوم. والسبب
  // مذكور صراحةً لأن «سجّل دخولك مجددًا» بلا سبب يُقرأ عطلًا في الموقع.
  session_idle:
    'انتهت جلستك لأسباب أمنية بعد فترة من عدم النشاط. يرجى تسجيل الدخول مرة أخرى.',
  session_expired:
    'انتهت جلستك لأسباب أمنية بعد بلوغ مدتها القصوى. يرجى تسجيل الدخول مرة أخرى.',
  session_invalid:
    'انتهت جلستك لأسباب أمنية، يرجى تسجيل الدخول مرة أخرى.',
  signed_out_everywhere:
    'تم تسجيل خروجك من جميع الأجهزة. سجّل الدخول مرة أخرى للمتابعة.',
};
