...
الملف `docs/legal/badiha-license-deck.pptx` — اثنتا عشرة شريحة:

| # | الشريحة | يغطّي |
|---|---|---|
| ١ | الغلاف | الاسم والتعريف |
| ٢ | المقدمة: السياق والتحدي | ربط برؤية ٢٠٣٠ |
| ٣ | من تربط المنصة | الأطراف الأربعة |
| ٤ | نبذة عن المشروع | **نظرة عامة** + النشاط ورموز التصنيف |
| ٥ | المميزات المنفَّذة | **الخدمات والحلول** — ٢٠ ميزة في ٥ محاور |
| ٦ | الذكاء الاصطناعي داخل المنصة | ٧ أدوار منها وكيلان |
| ٧ | الابتكار والركائز التقنية | الاسترجاع الهجين · إصلاح PDF العربي · المدقّق الحتمي · حصانة حقن الأوامر |
| ٨ | القيمة المضافة للعميل | لماذا يشتري |
| ٩ | نموذج العمل والسوق | **النشاطات الرئيسية والقطاعات المستهدفة** |
| ١٠ | المالية والتوظيف ٥ سنوات | مطابقة لخطاب النوايا |
| ١١ | الميزة القادمة: استوديو السياسات | مواصفة معتمدة غير منشورة — تُعرض كخطة لا كميزة قائمة |
| ١٢ | خطة التوسع | المملكة ← الخليج ← الأسواق العربية |

أرسليه **PPTX** كما طلبوا، وأرفقي PDF معه احتياطًا.

> **قاعدة محفوظة في الملف**: الشريحة ١١ وحدها تصف ميزة غير منشورة، وهي
