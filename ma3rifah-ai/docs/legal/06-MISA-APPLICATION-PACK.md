...
الملف `docs/legal/badiha-license-deck.pptx` يغطّي الأربعة:

| المطلوب | الشريحة |
|---|---|
| نظرة عامة للمشروع | ٢ (المقدمة) · ٥ (النبذة) |
| الخدمات والحلول المقدَّمة | ٦ (القيمة المضافة والحلول) · ٤ (التقنيات) |
| النشاطات التجارية الرئيسية | ٥ (النشاط + رموز التصنيف) · ٨ (نموذج الإيرادات) |
| القطاعات المستهدفة | ٨ (السوق المستهدف) · ١٠ (التوسع) |
